...
# Comprehensive tips based on symptoms or diseases
symptom_tips = {
    "cough": [
...
def predict_disease(user_symptoms):
    # Convert symptom input to binary vector
    ...
    # Get tips based on entered symptoms
    tips = get_symptom_tips(user_symptoms)

    return predicted_disease, tips, tips  # returning same tips twice for consistency
